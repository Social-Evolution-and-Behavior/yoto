...
- **Self-describing output**: every clean pickle carries a `df.attrs` block with the YOTO version, all knobs used, per-step counts, and the imaging scale — see [the cleaning guide](guides/cleaning.md#pickle-attributes)
